    ...
    <div className="w-full relative">
      ...
      {isTextArea ? (
        <Input.TextArea
          ...
          className={`w-full border border-[#77C4FE] px-4 py-2 text-[16px] bg-[#D5EDFF4D] text-gray-700 rounded-lg focus:border-[#77C4FE] ${className}`}
        ...
        <Input
          prefix={Icon && <Icon className="text-black bg-[#D5EDFF4D] text-xl" />} // Dynamic icon
          placeholder={placeholder || "Enter value"} // Dynamic placeholder
          className={`w-full border border-[#77C4FE] px-4 py-2 text-[16px] bg-[#D5EDFF4D] text-gray-700 rounded-lg focus:border-[#77C4FE] ${className}`} // Apply focus color
