...
const MyValues = () => {
  ...
  return (
    <div className="w-full bg-[#FAF6FA] py-16  px-5">
      <MainContainer>
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 my-10">
          {values?.map((value, i) => (
            <div
              key={i}
              className="w-full h-full bg-blue-400 py-0.5 rounded-3xl"
            >
              <div className="w-full bg-[#F1F9FF] p-6 space-y-4 rounded-3xl">
                <div className="size-16 bg-blue-400 rounded-full flex justify-center items-center">
